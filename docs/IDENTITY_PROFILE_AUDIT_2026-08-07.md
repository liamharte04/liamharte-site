...
- Name: `Liam Harte`
- Stable person identifier: `https://liamharte.com/#person`
- Official personal website: `https://liamharte.com/`
- Official founder profile: `https://liamharte.com/rephobia-founder/`
- Company website: `https://rephobia.com/`
- Controlled LinkedIn profile: `https://www.linkedin.com/in/liamharte04`
- Controlled GitHub profile: `https://github.com/liamharte04`
...
| Queen's University Belfast profiles | Independently identify Liam and Rephobia. Editorial control belongs to QUB. | Publisher request prepared | Ask QUB to add the official personal profile where editorially appropriate and keep current graduate/founder facts accurate. |
| Award and programme profiles | Strong independent corroboration exists, but many pages do not link to Liam's official personal site. | Publisher request prepared | Use individual, accuracy-led requests. Do not request keyword-rich anchors or bulk changes. |
...
- Do not create academic profiles such as Google Scholar or ORCID solely for
  search positioning.
- Do not create a self-authored Wikipedia article or commission promotional
  editing.
- Do not duplicate biographies across thin directory pages.
- Do not ask publishers to remove accurate coverage of another Liam Harte.
- Report a search feature only when it actually mixes people, not merely when a
  legitimate same-name result ranks prominently.
